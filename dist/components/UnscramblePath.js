...
var deshuffleArray_1 = require("../functions/deshuffleArray");
var react_1 = require("react");
var RenderImageFromPieces_1 = require("./RenderImageFromPieces");
function UnscramblePath(_a) {
    ...
    var _e = (0, react_1.useState)([]), unscrambledPieces = _e[0], setUnscrambledPieces = _e[1];
    ...
    (0, react_1.useEffect)(function () {
        if (imagePieces.length === complexity * complexity) {
            setUnscrambledPieces((0, deshuffleArray_1.deshuffleArray)(imagePieces, cipherKey));
        }
    }, [imagePieces]);
    return (React.createElement("div", { style: { display: "flex", justifyContent: "center", alignItems: "center" } }, onePiece
        ? React.createElement(RenderImageFromPieces_1.default, { pieces: unscrambledPieces, width: width, height: height })
        : React.createElement(ImageSlices_1.default, { pieces: unscrambledPieces, width: width, height: height })));
}
exports.default = UnscramblePath;
