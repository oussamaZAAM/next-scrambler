...
exports.encryptImageToFormdata = exports.scrambleCanvas = exports.canvasToBlob = void 0;
...
function encryptImageToFormdata(file, complexity, cipherKey) {
    return __awaiter(this, void 0, void 0, function () {
        var reader, chunks, _a, done, value, buffer, image, width, height, canvas, ctx, imagePieces, imagePromises, images, totalImages, columns_1, rows, cellWidth_1, cellHeight_1, scrambledCanvas, scrambledContext_1, blob, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, canvasToBlob(scrambledCanvas)];
                case 8:
                    blob = _b.sent();
                    return [2 /*return*/, blob];
                case 9:
...
exports.encryptImageToFormdata = encryptImageToFormdata;
